    ...
    const CONFIG = {
      ...
      SITES: [
        ...
        { id: "racingtv", name: "Racing TV", region: "europe", url: "https://www.racingtv.com/news/latest", baseUrl: "https://www.racingtv.com", parser: "generic", pathHints: ["/news"], preferTextProxy: true, textProxyOnly: true, maxItems: 8 },
        ...
        { id: "paulickreport", name: "Paulick Report", region: "america", url: "https://paulickreport.com/news", baseUrl: "https://paulickreport.com", parser: "generic", pathHints: ["/news/"], includeAnySameHost: true, preferTextProxy: true, requireMarkdownImage: true },
    ...
    const I18N = {
      ...
      en: {
        ...
        subtitle: ({ days }) => `Track horse racing news from Europe, America, Australia, New Zealand, and Hong Kong for the last ${days} day${days === 1 ? "" : "s"}`,
        searchLabel: "Headline search",
        searchPlaceholder: "Search headline, source, region, or site",
        refresh: "Refresh",
        ...
        allSites: "All sites",
        currentFilter: ({ region, site, search, count }) => `${region} / ${site}${search ? ` / Search: ${search}` : ""} / ${count}`,
        ...
        resultSuffix: ({ filter, count }) => `${filter} showing ${count}`,
        searchSuffix: ({ filter, count, days, total }) => `${filter} search results ${count} / ${total} within ${days} day${days === 1 ? "" : "s"}`,
        ...
        dateEstimatedTitle: ({ date }) => `Estimated from listing order: ${date}`,

(function () {
    ...
    const CONFIG = {
      ...
      SITES: [
        ...
        { id: "trc_racing", name: "Thoroughbred Racing Racing", region: "europe", url: "https://www.thoroughbredracing.com/racing/", apiUrl: THOROUGHBRED_RACING_RSS_API, feedUrl: THOROUGHBRED_RACING_RSS, rssCategory: "Racing", baseUrl: "https://www.thoroughbredracing.com", parser: "generic", pathHints: ["/racing/"], includeAnySameHost: true, tryDirect: true, structuredSourcesOnly: true, allowEmptyStructured: true, exclusiveStructuredJson: true },
        { id: "trc_breeding_sales", name: "Thoroughbred Racing Breeding", region: "europe", url: "https://www.thoroughbredracing.com/breeding-and-sales/", apiUrl: THOROUGHBRED_RACING_RSS_API, feedUrl: THOROUGHBRED_RACING_RSS, rssCategory: "Breeding", baseUrl: "https://www.thoroughbredracing.com", parser: "generic", pathHints: ["/breeding-and-sales/"], includeAnySameHost: true, tryDirect: true, structuredSourcesOnly: true, allowEmptyStructured: true, exclusiveStructuredJson: true },
        { id: "trc_sales_previews", name: "Thoroughbred Racing Sales", region: "europe", url: "https://www.thoroughbredracing.com/sales-previews/", apiUrl: THOROUGHBRED_RACING_RSS_API, feedUrl: THOROUGHBRED_RACING_RSS, rssCategory: "Sales Previews", baseUrl: "https://www.thoroughbredracing.com", parser: "generic", pathHints: ["/sales-previews/"], includeAnySameHost: true, tryDirect: true, structuredSourcesOnly: true, allowEmptyStructured: true, exclusiveStructuredJson: true },
        ...
        { id: "ttrausnz", name: "TTR AusNZ", region: "australia", url: "https://www.ttrausnz.com.au/", baseUrl: "https://www.ttrausnz.com.au", parser: "generic", pathHints: ["/edition/", "/news/", "/articles/"], includeAnySameHost: true, preferTextProxy: false, allowTextProxy: false },
